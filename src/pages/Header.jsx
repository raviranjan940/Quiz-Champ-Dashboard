        ...
        <div className="relative w-full bg-white print:hidden">
            <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-2 sm:px-6 lg:px-8">
                <div className="inline-flex items-center space-x-2">
                    <img src="/quizChampLogo.png" className="h-12" />
                    <p>
                        <span className="font-bold text-2xl text-gray-800">
                            Quiz Champ
                        </span>
                        <span className="hidden lg:inline-flex text-xs font-semibold text-orange-400 ">
                            Admin Panel
                        </span>
                    </p>
                </div>
                        ...
                        <div className="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
                            <div className="px-5 pb-6 pt-5">
                                ...
                                <button
                                    onClick={handleLogout}
                                    type="button"
                                    className="mt-4 w-full rounded-md bg-red-500 px-3 py-2 text-sm font-semibold text-white shadow-sm hover:bg-black/80 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-black"
                                >
                                    Logout
                                </button>
                            </div>
